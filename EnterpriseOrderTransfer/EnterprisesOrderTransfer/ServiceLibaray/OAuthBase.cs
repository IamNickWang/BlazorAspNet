...
namespace EnterprisesOrderTransfer.ServiceLibaray
{
    public class OAuthBase
    {
        ...
        public string GenerateSignatureBase(Uri url, string consumerKey, string token, string tokenSecret, string httpMethod, string timeStamp, string nonce, string signatureType, out string normalizedUrl, out string normalizedRequestParameters)
        {
            ...
            //File.AppendAllText(@"U:\Projects\ERP_Extract_for_Anaplan\erpDataWithTBA\erpDataWithTBA\bin\Debug\net5.0\signatureBase.txt", signatureBase.ToString());
        ...
        public virtual string GenerateNonce()
        {
            ...
            //return (random.Next(0, 9999999)).ToString();



            string result = "";
            string extra = DateTime.Now.ToString("yyyyMMddHHmmss").Substring(8, 6);
            ...
            while (result.Length < 32)
            {
                ...
                result += Convert.ToBase64String(sha1.ComputeHash(Encoding.ASCII.GetBytes(sb.ToString()))).TrimEnd('=').Replace("/", "").Replace("+", "");
            }
